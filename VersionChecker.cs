...
namespace DrakiaXYZ.VersionChecker
{
    ...
    public class VersionChecker : Attribute
    {
        ...
        public static bool CheckEftVersion(ManualLogSource Logger, PluginInfo Info, ConfigFile Config = null)
        {
            ...
            int buildVersion = TYR_DeHazardifier.DeClutter.TarkovVersion;
            if (currentVersion != buildVersion)
            {
                string errorMessage = $"ERROR: This version of DeHazardifier changer was built for Tarkov {buildVersion}, but you are running {currentVersion}. Please download the correct plugin version.";
